...
class Actor(DeterministicMixin, Model):
    ...
    def compute(self, inputs, role):
        ...
        return self.action_layer(x), {"rnn": [rnn_states[0], rnn_states[1]]}
...
env = gym.wrappers.RecordVideo(env, "videos/torch/BipedalWalkerTD3-LSTM", lambda episode: episode % 20 == 0)
env = wrap_env(env)
...
cfg["experiment"]["directory"] = "runs/torch/BipdealWalkerTD3-LSTM"
